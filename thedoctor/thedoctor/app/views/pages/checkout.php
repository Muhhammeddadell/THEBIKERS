      ...
      <form action="" method="post" name="order">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <label for="floor"> Date of birth </label>
            <input type="text" class="a" id="floor" name="floor" placeholder="1,2.." required="true" pattern="[0-9]{1,10}" title="Please date of birth">            
            <h3>Payment</h3>
            <label>
