...
<select class="btn  dropdown-toggle" name="choice" style="width:60%; border:2px solid #808080;">
  <option value="none" selected disabled hidden> Topic</option>
  ...
  <option value="4">Gifts</option>
      ...
      <div  style=" padding-top: 30px; ">
              ...
              <textarea class="form-control center-block" style="width:60% ;border:2px solid #808080;" type="text" required="true" name="" ></textarea>
            </div>
